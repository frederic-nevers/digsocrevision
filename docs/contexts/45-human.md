...
🗞️ **News item**: In 2020, the crowdsourced protein folding game Foldit challenged players to design antiviral proteins that could potentially block the SARS-CoV-2 virus, demonstrating the power of citizen science in addressing global health challenges. ([Source](https://scistarter.org/foldit))