...
const config = {
  ...
  url: 'https://digsoc.fredericnevers.com',
  ...
  organizationName: 'frederic-nevers', // Usually your GitHub org/user name.
  projectName: 'digsocrevision', // Usually your repo name.
